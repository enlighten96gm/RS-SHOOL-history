    ...
    return (
        <div>
            ...
            ? <div className={css.single}>
                <div onClick={deleteWordHeandler} className={css.delete__word}>delete</div>
                <div><span className={css.span}>Word:</span>  {item[1][0]}</div>
                <div><span className={css.span}>Translation:</span>  {item[1][1]}</div>
                <div onClick={soundHeandler} className={css.sound}><span className={css.span}>Sound: </span>Click Me</div>
                <div><span className={css.span}>Image:</span></div>
                <img className={css.image__word} src={`${image}`} alt=""/>
                <div onClick={changerHeandler} className={css.button__change}>CHANGE</div>
            </div>
                ...
                <div className={css.inputs}>
                    ...
                    <div className={css.sound_img__adder}>
                        <div className={css.sound_add}>
                            ...
                            <div className={css.input__outer}><input onChange={handleNewSound} className={css.sound_add_input} type="file"/>Change Sound</div>
                            
                        </div>
                        <div className={css.image_add}>
                            <div className={css.image_add_text}>Image: </div>
                            <div className={css.input__outer}><input onChange={handleNewImage} className={css.sound_add_input} type="file"/>Change Image</div>
                        </div>
                    </div>
                    <div className={css.buttons__adder}>
                        <div onClick={changerHeandler} className={css.cancel__adder}>Cancel</div>
                        <div onClick={handleChangeWord} className={css.add__adder}>Add</div>
                    </div>
                </div>
            </div>
        }   
