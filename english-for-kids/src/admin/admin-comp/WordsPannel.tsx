            ...
            <div className={css.gap__words}>
                ...
                ? <div className={css.single__new}>
                    ...
                    <div onClick={addNewWordheandler} className={css.adder}>
                        <div className={css.adder__lin1}></div>
                        <div className={css.adder__lin2}></div>
                    </div>
                  </div>
                :
                      ...
                      <div className={css.inputs}>
                          ...
                          <div className={css.sound_img__adder}>
                              <div className={css.sound_add}>
                                  ...
                                  <div className={css.input__outer}><input onChange={handleNewSound} className={css.sound_add_input} type="file"/>Add Sound</div>
                                  
                              </div>
                              <div className={css.image_add}>
                                  <div className={css.image_add_text}>Image: </div>
                                  <div className={css.input__outer}><input onChange={handleNewImage} className={css.sound_add_input} type="file"/>Add Image</div>
                              </div>
                          </div>
                          <div className={css.buttons__adder}>
                              <div onClick={addNewWordheandler} className={css.cancel__adder}>Cancel</div>
                              <div onClick={createStateCard} className={css.add__adder}>Add</div>
                          </div>
                      </div>
                  </div>
                }
