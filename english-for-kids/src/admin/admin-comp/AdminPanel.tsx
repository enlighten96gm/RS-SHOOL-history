...
const AdminPanel = ({dataCard, adminName, rerenderHeandler, changeColor, setCorrectPath}: any) => { 
    ...
    const singleSet = arr.map((item: any) => {
        return <SingleCategoryComp item={item} adminName={adminName} rerenderHeandler={rerenderHeandler} changeColor={changeColor} setCorrectPath={setCorrectPath}/> 
    })
        ...
        <div className={css.sets}>
            ...
            <div className={css.single}>
                ...
                : <div className={css.categoryChanger}>
                    <input onChange={handleCategoreName} value={categoryName} className={css.inputCategory} placeholder='Category' type="text"/>
                    <div className={css.buttonImage}><input className={css.upload} onChange={handleFile} type="file" placeholder='Add Image'/><div className={css.add}>Add Image</div></div>
                  </div>}
