...
const Registration = ({setAdminName, adminName}: any) => {
    ...
    <div className={css.main}>
        ...
        <div className={css.input__main}>
            ...
            <input className={flag === false ? css.second__input : css.active1} type="text" placeholder={'Password'} {...password}/>
            <input className={flag === false ? css.third__input : css.active2} type="text" placeholder={'Confirm Password'} {...confirmPassword}/>
        </div>        
        <div className={css.footer}>
            <NavLink className={css.cancel__btn} to='/Sets'>
                <div>Cancel</div>
            </NavLink>
            <div onClick={registerHeandler} className={css.login__btn}>Register</div>
        </div>
    </div>
)
}
